...
(5, 'MEXICAN NIGHT', '2021/04/08 19:00', 'Via Luigi Luzzati, 10 Padova, PD', "Serata messicana! Per l'occasione ci saranno non solo panini, ma anche altri piatti tipici messicani come tacos e burritos. Vivi anche tu questo tuffo nella cultura messicana in compagnia. Per l'occasione avremo anche una piccola band che ci intratterrà per tutta la serata con musica tipica. Non mancare!"),
(6, "GIORNATA MONDIALE DELL'HAMBURGER", '2021/05/28 19:00', 'Via Luigi Luzzati, 10 Padova, PD', "Festeggia con Burgheria Padovana la giornata mondiale dell'Hamburger. Per l'occasione si potra ordinare il nuovo AMERICANO, il nuovo panino pensato apposta per portare l'America anche qua a Padova! Gustati la buonissima carne di black angus con il cheddar tra due fette di pane al latte croccante con i semi di sesamo. Ti aspettiamo!"),
