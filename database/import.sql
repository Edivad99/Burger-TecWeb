...
(6, "GIORNATA MONDIALE DELL'HAMBURGER", '2021/05/28 19:00', 'Via Luigi Luzzati, 10 Padova, PD', "Festeggia con Burgheria Padovana la giornata mondiale dell'Hamburger. Per l'occasione si potra ordinare il nuovo USA, il nuovo panino pensato apposta per portare l'America anche qua a Padova! Gustati la buonissima carne di black angus con il cheddar tra due fette di pane al latte croccante con i semi di sesamo. Ti aspettiamo!"),
