...
(1, 'QUARANTINO', '2020/11/18 19:00', 'Via Luigi Luzzati, 10 Padova, PD', "Anche durante il periodo di Lockdown gli eventi della Burgheria Padovana non mancano. Ordina a casa il nuovo Quarantino, il panino pensato per non farti mancare niente, neanche in quarantena! Ma l'evento non finisce qua, in tutte le ordinazioni che riceveremo questa sera avranno un Qr-code per potervi collegare in diretta al nostro video-evento con musica e non solo, così da poter fare festa tutti insieme al sicuro nelle nostre case. Partecipa anche tu!"),
(2, 'GIORNATA MONDIALE DEL PANINO', '2020/11/21 19:00', 'Via Luigi Luzzati, 10 Padova, PD', "Apertura speciale per festeggiare la giornata mondiale del Panino. Per l'occasione avremo panini con soli ingredienti tradizionali italiani e con pane a scelta tra mantovana, cioppa oppure bastone, tutte forme di pane tipiche del territorio. Non perdere l'occasione di poter gustare un buon panino in questa serata speciale!"),
(3, 'GIORNATA MONDIALE DEL PANINO', '2019/11/21 19:00', 'Via Luigi Luzzati, 10 Padova, PD', "Non perdere l'occasione di poter gustare un buon panino in questa serata speciale!"),
(4, 'DUE CUORI E UN PANINO', '2021/02/14 19:00', 'Via Luigi Luzzati, 10 Padova, PD', "Approfitta dell'apertura speciale. In occasione della festa degli innamorati potrai gustare, insieme alla tua dolce metà, il nuovo panino: San Valentino. Questo panino è stato pensato apposta per essere mangiato da due persone. Chiama per ordinare da casa oppure per prenotare un tavolo. Ti(Vi) aspettiamo!"),
(5, "<span lang=""en"" >MEXICAN NIGHT</span>", '2021/04/08 19:00', 'Via Luigi Luzzati, 10 Padova, PD', "Serata messicana! Per l'occasione ci saranno non solo panini, ma anche altri piatti tipici messicani come tacos e burritos. Vivi anche tu questo tuffo nella cultura messicana in compagnia. Per l'occasione avremo anche una piccola band che ci intratterrà per tutta la serata con musica tipica. Non mancare!"),
(6, "GIORNATA MONDIALE DELL'HAMBURGER", '2021/05/28 19:00', 'Via Luigi Luzzati, 10 Padova, PD', "Festeggia con Burgheria Padovana la giornata mondiale dell'Hamburger. Per l'occasione si potra ordinare il nuovo <abbr title=""United States of America"" lang=""en"">USA</abbr>, il nuovo panino pensato apposta per portare l'America anche qua a Padova! Gustati la buonissima carne di <span lang=""en"">black angus</span> con il <span lang=""en"">cheddar</span> tra due fette di pane al latte croccante con i semi di sesamo. Ti aspettiamo!"),
(7, 'COMPLEANNO BURGHERIA PADOVANA', '2021/08/20 19:00', 'Via Luigi Luzzati, 10 Padova, PD', "Festeggia con noi questi incredibili due anni della Burgheria Padovana. Non mancare in questa serata piena di mini-eventi e regali per i nostri amati clienti. All'evento potranno partecipare anche i nostri amici da casa, quindi non hai scuse per mancare!"),
(8, 'COMPLEANNO BURGHERIA PADOVANA', '2020/08/20 19:00', 'Via Luigi Luzzati, 10 Padova, PD', "E' stato un anno davvero pieno di bellissimi ricordi, emozioni ma anche qualche situazione difficile. Vieni a condividere con tutti noi di Burgheria Padovana com'è stato quest'anno con la compagnia dei nostri fantastici panini. Sicuramente non mancheranno regali e sorprese per i clienti più affezionati. Ovviamente non possiamo escludere i nostri amici da casa. Non mancate!"),
(9, "<span lang=""en"" >BURGHERIA'S GOT TALENT</span>", '2021/03/12 19:00', 'Via Luigi Luzzati, 10 Padova, PD', 'Partecipa a questa splendida serata dedicata interamente ai nostri amati clienti! Durante questo evento gli iscritti dovrannon mostrare i loro più strebilianti talenti, sia ai presenti che ai nostri amici da casa. Dopodichè i talenti più votati verranno premiati con panini e gift card della Burgheria. Che aspetti, chiama e iscriviti anche tu!'),
(10, 'PANINO PRIMA DEGLI ESAMI', '2021/06/15 19:00', 'Via Luigi Luzzati, 10 Padova, PD', "Cari studenti, venite a eliminare l'ansia pre-esami con i nostri fantastici panini, per voi uno sconto del 50% su tutto il menu. Vedrete, 100 e lode assicurato!"),
(11, 'SERATA CON CHEF RUBIO', '2021/06/30 19:00', 'Via Luigi Luzzati, 10 Padova, PD', 'Serata speciale in compagnia dello chef Gabriele Rubini, conosciuto meglio come Chef Rubio. Venite a fare due chiacchere con lo Chef mentre assaggiate le sue speciali creazioni fatte apposta per la Burgheria Padovana. Non mancate!'),
