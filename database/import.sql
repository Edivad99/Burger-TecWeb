...
(7, 'COMPLEANNO BURGERIA PADOVANA', '2021/08/20, 12:00-16:00 e 19:00-02:00', 'Via Luigi Luzzati, 10 Padova, PD', "Festeggia con noi questi incredibili due anni della Burgheria Padovana. Non mancare in questa giornata piena di eventi e regali per i nostri amati clienti. All'evento potranno partecipare anche i nostri amici da casa, quindi non hai scuse per mancare!"),
(8, 'COMPLEANNO BURGERIA PADOVANA', '2020/08/20, 12:00-16:00 e 19:00-02:00', 'Via Luigi Luzzati, 10 Padova, PD', "E' stato un anno davvero pieno di bellissimi ricordi, emozioni ma anche qualche situazione difficile. Vieni a condividere con tutti noi di Burgeria Padovana com'è stato quest'anno con la compagnia dei nostri fantastici panini. Sicuramente non mancheranno regali e sorprese per i clienti più affezionati. Ovviamente non possiamo escludere i nostri amici da casa. Non mancate!"),
...
(11, 'SERATA CON CHEF RUBIO', '2021/06/30, 19:00-02:00', 'Via Luigi Luzzati, 10 Padova, PD', 'Serata speciale in compagnia dello chef Gabriele Rubini, conosciuto meglio come Chef Rubio. Venite a fare due chiacchere con lo Chef mentre assaggiate le sue speciali creazioni fatte apposta per la Burgheria Padovana. Non mancate!'),
(12, "L'HAMBURGHER E IL SECCHIONE", 'dal 2021/07/05 al 2021/07/09', 'Via Luigi Luzzati, 10 Padova, PD', 'Settimana speciale per i nostri universitari che hanno appena finito la sessione estiva. Chiunque abbia preso 30 in un qualsiasi esame di questa sessione otterrà un panino a scelta gratis. Dimostriamo al mondo che gli hamburgher sono del carburante fantastico per studiare al top!');
